...
from utils.supabase_mirror import mirror_sale, mirror_sale_delete
...
class Sales(commands.Cog):
    ...
    async def edit(
        ...
        await mirror_sale(self.bot, sale_id)
        await interaction.response.send_message(
    ...
    async def delete(self, interaction: discord.Interaction, sale_id: int):
        ...
        await mirror_sale_delete(self.bot, sale_id)
